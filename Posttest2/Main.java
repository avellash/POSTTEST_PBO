...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        daftarPeserta.add(new Peserta("Choi Jungeun", 19, "Korea", "Vocal"));
        daftarPeserta.add(new Peserta("Bang Jeemin", 18, "Korea", "Dance"));
        daftarPeserta.add(new Peserta("Fuko", 20, "Jepang", "Vocal"));
        daftarPeserta.add(new Peserta("Koko", 18, "Jepang", "Rap"));
        daftarPeserta.add(new Peserta("Kim Gyuri", 20, "Korea", "Vocal"));
        daftarPeserta.add(new Peserta("Jeong Saebi", 17, "Korea", "Dance"));
        daftarPeserta.add(new Peserta("Ryu Sarang", 20, "Korea", "Rap"));
        daftarPeserta.add(new Peserta("Nam Yuju", 18, "Korea", "Rap"));
        daftarPeserta.add(new Peserta("Mai", 21, "Jepang", "Dance"));
        daftarPeserta.add(new Peserta("Lingling", 18, "Malaysia", "Vocal"));
    ...
    public static void tambahPeserta() {
        ...
        Peserta pesertaBaru = new Peserta(nama, umur, negara, posisi);
    ...
    public static void updatePeserta() {
        ...
        if (index >= 0 && index < daftarPeserta.size()) {
            ...
            Peserta p = daftarPeserta.get(index);
